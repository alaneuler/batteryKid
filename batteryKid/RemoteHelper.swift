...
class RemoteHelper {
  ...
  private func getConnection() -> NSXPCConnection? {
    let privilegeHelperInstalled = FileManager.default.fileExists(atPath: Constants.PRIVILEGE_HELPER_PATH)
  ...
  private func createConnection(_ privilegeHelperInstalled: Bool) -> NSXPCConnection {
